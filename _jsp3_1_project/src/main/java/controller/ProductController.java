...
public class ProductController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		else if (path.equals("productmodify.pd")) {
			req.setAttribute("pvo", svc.getProductDetail(Integer.parseInt(req.getParameter("pno"))));
			destPage = "/product/productmodify.jsp";
		}
		else if (path.equals("productupdate.pd")) {
			ProductVO pvo = new ProductVO(Integer.parseInt(req.getParameter("pno")), req.getParameter("pname"), Integer.parseInt(req.getParameter("price")), req.getParameter("made_by"));
			int isUp = svc.productModify(pvo);
			destPage = "productdetail.pd";
		}
		else if (path.equals("productremove.pd")) {
			int isUp = svc.productRemove(Integer.parseInt(req.getParameter("pno")));
			destPage = "/index.jsp";
		}
